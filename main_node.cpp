...
int main(){
    ...
    shared_ptr<cadmium::dynamic::modeling::coupled<TIME>> NODE1;
    ...
    NODE2 = make_shared<dynamic::modeling::coupled<TIME>>(
    ...
    dynamic::modeling::EICs eics_SIM = {
        ...
        dynamic::translate::make_EIC<inp_SIM, inp_in1>("NODE3"),
        dynamic::translate::make_EIC<inp_SIM, inp_in1>("NODE4"),
        dynamic::translate::make_EIC<inp_SIM, inp_in1>("NODE5")
