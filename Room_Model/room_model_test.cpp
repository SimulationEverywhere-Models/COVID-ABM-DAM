...
//struct outp_out1 : public cadmium::out_port<person_node>{};
...
template<typename T>
class InputReader_room_model1 : public iestream_input<room_specs, T> {
    public:
        InputReader_room_model1 () = default;
        InputReader_room_model1 (const char* file_path) : iestream_input<room_specs,T> (file_path) {}
};
...
*/
    ...
    shared_ptr<dynamic::modeling::model> RoomModel1= dynamic::translate::make_dynamic_atomic_model<Room_Model, TIME, long, long>("Room", 10, 400);
