...
int main(){
    ...
    shared_ptr<dynamic::modeling::model> BehaviourRules1 = dynamic::translate::make_dynamic_atomic_model<BehaviourRules, TIME, string, TIME, TIME > ("BehaviourRules", "../data/Student1.xml", TIME("01:30:00:00"), TIME("01:50:00:00"));
