...
int main(){
    ...
    const char * i_input_data = "../input_data/room_specs_input.txt";
    ...
    //Loggers
    static ofstream out_messages("../simulation_results/RoomSpecsFilter_test_output_messages.txt");
    ...
    static ofstream out_state("../simulation_results/RoomSpecsFilter_test_output_state.txt");
