...
int main(){
    ...
    TIME InRoom = TIME("00:12:00:000");
    TIME AtHome = TIME("00:07:00:000");

    DecisionMakerBehaviour person;
    person.load("../data_structures/Student1.xml"); // Include constructor path to the XML file with Sean's load method
    //long in_person;

    /****** Input Reader atomic models instantiation *******************/
    const char * i_input_health = "../BehaviourRules_health_status_input.txt";
	...
	const char * i_input_room = "../BehaviourRules_room_specs_input.txt";
    ...
    shared_ptr<dynamic::modeling::model> BehaviourRules1 = dynamic::translate::make_dynamic_atomic_model<BehaviourRules, TIME, string, TIME, TIME > ("BehaviourRules", "../data_structures/Student1.xml", move(InRoom), move(AtHome));
